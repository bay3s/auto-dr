...
*Codebase*
- You should be able to find the meat of the logic and implementation under [auto_dr/randomization](https://github.com/bay3s/auto-dr/tree/main/auto_dr/randomization) folder here 
